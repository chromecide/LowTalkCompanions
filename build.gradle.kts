...
// LowTalk is a sibling checkout during development: its jar is compiled against and staged as a mod for runServer.
val lowTalkJar = file(property("lowtalk_jar").toString())

dependencies {
    vineImplementation(files(lowTalkJar))
}
